...
rm -f ../../data/sqlite/CampaignFin14.db
...
cat ../../data/raw/CampaignFin14/indivs14.txt | sed -e 's/|/"/g' | ../SanitizeCSV.py > ./indivs14.sanitized

sqlite3 ../../data/sqlite/CampaignFin14.db < ../CreateTables.sql
sqlite3 ../../data/sqlite/CampaignFin14.db < ./ImportCSV.sql
